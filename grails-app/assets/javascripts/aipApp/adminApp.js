...
//set application root url
    ...
    .constant("PAGES", {
        "admin-landing": {
            url: "/landing",
            templateUrl:  '../assets/aipApp/admin/adminLandingPage.html',
        ...
        "admin-action-list": {
            url: "/action",
            templateUrl: "../assets/aipApp/admin/action/list/adminActionListPage.html",
            breadcrumb: {
        ...
        "admin-post-list": {
            url: "/post",
            templateUrl: "../assets/aipApp/admin/action/post/postActionListPage.html",
            breadcrumb: {
        ...
        "admin-recurring-post-list": {
            ...
            templateUrl: "../assets/aipApp/admin/action/post/recurringPostActionListPage.html",
        ...
        "admin-post-add": {
            url: "/action/addjob",
            templateUrl: "../assets/aipApp/admin/action/post/adminPostItemAddPage.html",
        ...
        "admin-action-add": {
            url: "/action/add",
            templateUrl: "../assets/aipApp/admin/action/add/adminActionItemAddPage.html",
        ...
        "admin-action-open": {
            ...
            templateUrl: "../assets/aipApp/admin/action/open/adminActionItemOpenPage.html",
        ...
        "admin-group-list": {
            url: "/group",
            templateUrl: "../assets/aipApp/admin/group/list/adminGroupListPage.html",
        ...
        "admin-group-add": {
            url: "/group/add",
            templateUrl: "../assets/aipApp/admin/group/add/adminGroupAddPage.html",
        ...
        "admin-group-open": {
            ...
            templateUrl: "../assets/aipApp/admin/group/open/adminGroupOpenPage.html",
        ...
        "admin-status-list": {
            url: "/status",
            templateUrl: "../assets/aipApp/admin/status/list/adminStatusListPage.html",
            //controller: "AdminGroupListPageCtrl",
            breadcrumb: {
...
// TODO: should this be HTML5 in HashBang mode with a base defined in the HTML?
 ...
 bannerAIPUI
    ...
    .config(['$provide', 'APP_ROOT','APP_FOLDER_PATH', function ($provide, APP_ROOT,APP_FOLDER_PATH) {
            ...
            $provide.decorator("aipLandingItemDirective", ['$delegate',function ($delegate) {
                var directive = $delegate[0];
                directive.templateUrl = APP_FOLDER_PATH+ "assets/aipApp/common/directives/admin/landing-item/template/landingItem.html";
                return $delegate;
            }]);
            $provide.decorator("aipItemDetailDirective",['$delegate',function ($delegate) {
                var directive = $delegate[0];
                directive.templateUrl = APP_FOLDER_PATH+ "assets/aipApp/common/directives/item-detail/template/itemDetail.html";
                return $delegate;
            }]);

            $provide.decorator("aipGroupDetailDirective",['$delegate',function ($delegate) {
                var directive = $delegate[0];
                directive.templateUrl = APP_FOLDER_PATH+ "assets/aipApp/common/directives/admin/group-detail/template/groupDetail.html";
                return $delegate;
            }]);
            $provide.decorator("aipStatusRuleDirective", ['$delegate',function ($delegate) {
                var directive = $delegate[0];
                directive.templateUrl =  APP_FOLDER_PATH+ "assets/aipApp/common/directives/admin/status-rule/template/statusRule.html";
                return $delegate;
            }]);
            $provide.decorator("aipBlockedProcessDirective",['$delegate',function ($delegate) {
                var directive = $delegate[0];
                directive.templateUrl = APP_FOLDER_PATH+ "assets/aipApp/common/directives/admin/blockedProcess/template/blockedProcess.html";
                return $delegate;
            }]);
        }]
    );
...
angular.module("templates/tabNav.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("templates/tabNav.html",
        "<div class=\"xe-tab-container\" role=\"presentation\"><ul class=\"xe-tab-nav\" role=\"tablist\"><li ng-repeat=\"tab in tabnav.tabs\" ng-click=\"tabnav.activate(tab)\" ng-class=\"{active: tab.active}\" ng-repeat-complete aria-controls=\"{{'xe-tab-panel'+ ($index+1)}}\" aria-selected=\"{{tab.active}}\" tabindex=\"-1\" id=\"{{'xe-tab'+ ($index+1)}}\"><a ui-sref=\"{{ tab.state && tab.state || '#' }}\" href=\"#\" id=\"{{'tab'+ ($index+1)}}\" title=\"{{tab.heading}}\" ng-if=\"tab.state\">{{tab.heading}} <span></span></a> <a href=\"javascript:void(0)\;\" role=\"tab\" id=\"{{'tab'+ ($index+1)}}\" title=\"{{tab.heading}}\" ng-if=\"!tab.state\" aria-selected=\"{{tab.active}}\">{{tab.heading}} <span></span></a></li></ul><div class=\"xe-tab-content\" role=\"presentation\"><ng-transclude></ng-transclude></div></div>");
}]);
