...
def doCheckCopyrightXe(fixIt){
    ...
    appPlugins.each {
        ...
        def excludedFileExts = ["rst", "properties", "svg", "scss", "ttf", "woff", "woff2", "eot", "png", "gif", "map",
                                "jar"]
        def excludedFiles = "CheckCopyrightXe.groovy|package.json|.git|xe-ui-components|ckeditor|d3.min.js|angular-dateparser.min.js|cm-timepicker.js|bower.json|iconFonts-rtl.css|angular-aria.js|ui-bootstrap-csp-rtl.css|ui-bootstrap-csp.css|ui-bootstrap-tpls.js|ui-bootstrap.js|karma.conf.js"
