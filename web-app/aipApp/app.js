...
//constant for endpoint
    .constant("ENDPOINT", {
        admin: {
            ...
            getGroupLov:aipAppAbsPath + "aipActionItemPosting/getGroupLov?offset=0&max=10",
            populationListForSendLov:aipAppAbsPath + "aipActionItemPosting/getGroupLov?offset=0&max=10",
            getActionGroupActionItemLov:aipAppAbsPath + "aipActionItemPosting/getActionGroupActionItemLov?max=10&offset=0&",
